...
import {fetchNotifications} from "../../store/reducers/actionCreators";


const AdminPage = () => {
    const {isAdmin} = useAppSelector(state => state.adminReducer)
    const {editingProject} = useAppSelector(state => state.projectReducer)
    const {post} = useAppSelector(state => state.postReducer)
    const [currentTab, setCurrentTab] = useState(1)
    const dispatch = useAppDispatch()
    const notifications = useAppSelector(state => state.postReducer.postNotifications)
            ...
            <div className="admin-page__inner">
                <div className="container">
                    <div className="admin__tabs">
                        <div className="admin__tabs__row">
                            <h2
                        ...
                        <div className="admin__tabs__row">
                            ...
                            >
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M21 8V21H3V8" stroke="#333333" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                    <path d="M23 3H1V8H23V3Z" stroke="#333333" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                    <path d="M10 12H14" stroke="#333333" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                </svg>
                            </button>
                            <button
                                className={'notification-btn' + (currentTab === 4 ? ' active' : '')}
